...
/*
 * Теперь функция динамически отрисовует таблицу, добавлены 2 параметра $rows, $cols.
 * Если их не задавать, то по умолчанию таблица отрисуется 3x3.
 */
